...
if __name__ == "__main__":
    ...
    imgs_url_list = ['https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=3737181407,414881579&fm=15&gp=0.jpg',
                     'https://graph.baidu.com/thumb/3895848575,790090152.jpg',
                     'https://graph.baidu.com/thumb/2778222384,3159275776.jpg',
                     'https://graph.baidu.com/thumb/2850127107,1321839555.jpg',
                     'https://graph.baidu.com/thumb/1995449503,768654305.jpg',
                     'https://graph.baidu.com/thumb/658107739,2931640318.jpg',
                     'https://graph.baidu.com/thumb/3109918863,579663510.jpg',
                     'https://graph.baidu.com/thumb/1222315609,3025347750.jpg',
                     'https://graph.baidu.com/thumb/1731335460,73850934.jpg']
    cur_save_dir = 'D:\\baiduimage'

    # 获取百度识图结果
    for img_url in imgs_url_list:

        url_list = search_similar_images(browser, img_url, max_page=40)
